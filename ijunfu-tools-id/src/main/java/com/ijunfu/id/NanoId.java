...
public final class NanoId {
    ...
    public static String generate() {
        return generate(DEFAULT_NUMBER_GENERATOR, DEFAULT_ALPHABET, DEFAULT_SIZE);
    }
    ...
    public static String generate(int size) {
        return generate(DEFAULT_NUMBER_GENERATOR, DEFAULT_ALPHABET, size);
    }
     ...
     * @return A randomly generated NanoId String.
     */
    public static String generate(char[] alphabet, int size) {
        return generate(DEFAULT_NUMBER_GENERATOR, alphabet, size);
    }
     ...
     * @return A randomly generated NanoId String.
     */
    public static String generate(final Random random, final char[] alphabet, final int size) {
